...
/* harmony export */ });
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(701);
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_sass_loader_dist_cjs_js_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(902);
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_sass_loader_dist_cjs_js_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_1_use_1_sass_loader_dist_cjs_js_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_1__/* .default.locals */ .Z.locals || {});
        ...
        props.collectionPokemonView.sprites.back_default &&
            React.createElement("div", { className: "CompleteCard__background_back col-6 col-sm-12 col-md-12 col-lg-4 col-xl-4" },
                ...
                React.createElement("p", { className: "CompleteCard__text_back" },
                    ...
                    " de atr\u00E1s."))),
    React.createElement("div", { className: "CompleteCard__information row" },
        React.createElement("div", { className: "CompleteCard__presentation col-sm-12 col-md-12 col-lg-12 col-xl-12" },
            React.createElement("h2", { className: "CompleteCard__title_stats" },
                "Stats de ",
                props.collectionPokemonView.name)),
...
var react_1 = __importDefault(__webpack_require__(526));
var style_1 = __webpack_require__(833);
var Loading = function () { return (react_1.default.createElement(style_1.LoadingStyled, null,
    react_1.default.createElement("div", { className: "Loading__circle" }))); };
...
var styled_components_1 = __importDefault(__webpack_require__(993));
exports.LoadingStyled = styled_components_1.default.section.attrs({
    className: 'Loading'
...
var Modal = function (props) { return (React.createElement(style_1.ModalStyled, { stateModal: props.stateModal, "data-testid": "test__modal" },
...
var Presentation = function (props) { return (React.createElement(style_1.PresentationStyled, { "data-testid": "Presentation" },
    React.createElement("div", { className: "Presentation__row row" },
        ...
        props.collectionPokemonsView.length < 1 && props.isReady === true && (React.createElement(index_2.NotFound, null)),
...
var PreviewCard = function (props) { return (React.createElement(style_1.PreviewCardStyled, { "data-testid": "PreviewCard", key: props.pokemonId },
    React.createElement("div", { className: "PreviewCard__container container" },
...
var Search = function (props) { return (React.createElement(style_1.SearchStyled, null,
    React.createElement("div", { className: "Search__row row" },
        ...
        React.createElement("div", { className: "Search__function" },
        ...
        React.createElement("div", { className: "Search__content__social-media" },
            React.createElement("a", { className: "Search__content__link", target: "_blank", href: "https://github.com/Julian-Carelli" },
                React.createElement("i", { className: "Search__content__icon fab fa-github" })),
            React.createElement("a", { className: "Search__content__link", target: "_blank", href: "https://www.linkedin.com/in/julian-carelli/" },
                React.createElement("i", { className: "Search__content__icon fab fa-linkedin" })))))); };
...
var style_1 = __importDefault(__webpack_require__(215));
var index_1 = __webpack_require__(454);
...
var Home = function () {
    ...
    var _b = react_1.useState([]), pokemonsView = _b[0], setPokemonsView = _b[1];
    var _c = react_1.useState([]), pokemonView = _c[0], setPokemonView = _c[1];
    var _d = react_1.useState(undefined), pokemonName = _d[0], setPokemonName = _d[1];
    ...
    var _h = react_1.useState(undefined), error = _h[0], setError = _h[1];
    var getPokemons = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setLoading(true);
                    urlAllPokemon = 'https://pokeapi.co/api/v2/pokemon?limit=1118';
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4, fetch(urlAllPokemon)];
                case 2:
                    pokemons_1 = _a.sent();
                    return [4, pokemons_1.json()];
                case 3:
                    data = _a.sent();
    ...
    var searchCompletePokemon = function (pokemonId) { return __awaiter(void 0, void 0, void 0, function () {
        var urlPokemon, pokemon, data, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setLoading(true);
    ...
    var handleModal = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(modal === false)) return [3, 2];
                    pokemonId = e.target.id.slice(0, 5);
                    return [4, searchCompletePokemon(pokemonId)];
                case 1:
                    _a.sent();
                    return [2, setModal(true)];
                case 2:
                    setModal(false);
                    return [2];
            }
    ...
    return (react_1.default.createElement(styled_components_1.ThemeProvider, { theme: style_1.default },
        react_1.default.createElement("div", { "data-testid": "test__home", className: "Home container" },
            ...
            react_1.default.createElement(index_2.default, { collectionPokemonsView: pokemonsView, collectionPokemonView: pokemonView, handleModal: handleModal, isReady: isready, stateLoading: loading }))));
};
exports.Home = Home;
...
var App_1 = __importDefault(__webpack_require__(674));
